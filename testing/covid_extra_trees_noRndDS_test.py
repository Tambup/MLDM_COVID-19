...
datasets_names= ['dataset_finale_medie.csv','dataset_finale_medie_2_week.csv', 'dataset_finale_medie_1_week.csv']
...
df_results.to_csv('covid_extra_trees_noRndDs_test.csv')
