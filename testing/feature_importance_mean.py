...
datasets_names = ['dataset_finale_medie_rnd220.csv', 'dataset_finale_medie_ponderate_rnd1.csv', 'dataset_finale_medie_ponderate_rnd1.csv', 'dataset_finale_medie_ponderate_rnd1.csv', 
        'dataset_finale_medie_rnd220.csv', 'dataset_finale_medie_2_week_rnd1.csv', 'dataset_finale_medie_rnd1.csv', 'dataset_finale_medie_2_week_rnd1.csv', 'dataset_finale_medie_rnd220.csv',
        'dataset_finale_medie_ponderate_rnd1.csv', 'dataset_finale_medie_2_week_rnd1.csv', 'dataset_finale_medie_2_week_rnd1.csv']

rnd_states = [432145, 432145, 22, 22, 777, 22, 22, 6654, 22, 22, 22, 22]
...
feature_mean = {val : 0 for val in predictor_columns}
...
for i in range(len(datasets_names)):  
    ...
    for key in predictor_columns:
        feature_mean[key]=feature_mean[key]+feature_importance[key]


for key in predictor_columns:
    feature_mean[key]=feature_mean[key]/len(datasets_names)

with open('fi_mean.txt', 'w') as f:
    f.write(str(feature_mean))
